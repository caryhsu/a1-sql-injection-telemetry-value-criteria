...
@Slf4j
public class NormalTelemetryStatsRepository {
    ...
    public NormalTelemetryStatsRepository(
    ...
    public List<TelemetryStatistics> getTelemetryStats(
        ...
        String sql = String.format("""
              SELECT n.TLM_NAME,
                     d.TLM_VALUE
                FROM TLM_DATA d, TLM_NAME_DIM n
        ...
        log.info("parameters:\n" +
                        ...
                        "start={}, " +
                        "end={}",
                telemetryNames, categories, start, end);
    ...
    public TelemetryStatistics getTelemetryStats(
        ...
        log.info("parameters:\n" +
                        ...
                        "start={}, " +
                        "end={}",
                telemetryName, category, start, end);
